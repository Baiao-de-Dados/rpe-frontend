                ...
                <nav className="mt-4 w-full h-full mb-5 flex flex-col justify-start">
                    ...
                    <ul className="flex flex-col gap-4 pl-0 w-full max-lg:justify-start max-lg:gap-8 max-lg:mt-8 max-lg:pl-20 max-lg:w-auto">
                        ...
                        <RoleGuard anyRole={[ UserRoleEnum.EMPLOYER ]}>
                            <li className="list-none w-full max-lg:flex max-lg:justify-start max-lg:w-auto">
                                <NavLink to="/anotacoes" onClick={closeMenu} className={({ isActive }) => `flex items-center gap-4 no-underline relative transition-all duration-200 ease-in-out hover:text-secondary-600 max-lg:text-2xl max-lg:gap-4 ${isActive ? 'text-primary-500' : 'text-secondary-400'}`}>
                        ...
                        <RoleGuard anyRole={[
                            ...
                            <li className="list-none w-full max-lg:flex max-lg:justify-start max-lg:w-auto">
                                <NavLink to="/brutalfacts" onClick={closeMenu} title="Avaliação de ciclo" className={({ isActive }) => `flex items-center gap-4 no-underline relative transition-all duration-200 ease-in-out hover:text-secondary-600 max-lg:text-2xl max-lg:gap-4 ${isActive ? 'text-primary-500' : 'text-secondary-400'}`}>
