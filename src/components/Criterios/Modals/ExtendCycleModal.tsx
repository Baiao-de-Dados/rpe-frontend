...
import {
    getExtendCycleSchema,
    type ExtendCycleSchema,
} from '../../../schemas/extendCycleSchema';
        ...
        <Modal open={open} onClose={onClose}>
            ...
            >
                ...
                <Typography variant="body" className="text-gray-700 -mt-2">
                    Nova data:{' '}
                    <span className="font-semibold">
                        {watch('newDate') ? formatDate(watch('newDate')) : '-'}
                    </span>
                </Typography>
