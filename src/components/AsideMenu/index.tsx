...
export default function AsideMenu() {
    ...
    return (
        <>
            <OpenMenuIcon
                onClick={openMenu}
                className={'open-menu ' + (isMenuOpened ? 'hide' : '')}
                size={50}
                weight="bold"
            />
            <CloseMenuIcon
                onClick={closeMenu}
                className={'close-menu ' + (!isMenuOpened ? 'hide' : '')}
                size={50}
                weight="bold"
            />
            <AsideMenuWrapper
                id={isMenuOpened ? 'opened' : ''}
                className={isNavHovered ? 'expanded' : ''}
            >
